    ...
    <>
      ...
      <div className='secondsection px-4 xl:flex xl:justify-center'>
        <motion.div
          ...
          <motion.h1  className='  text-2xl lg:text-3xl font-semibold tracking-wider'>Skills</motion.h1>
          <motion.p className=' py-2 text-center lg:px-16'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestias accusantium id, ullam quidem consectetur harum pariatur et blanditiis doloribus repellat, porro nisi neque voluptatum quae, officia similique. Tenetur, exercitationem magn
          </motion.p>
          <motion.ul  variants={boxvariant}
          whileInView="visible"
          initial="hidden" className=' grid grid-cols-1 gap-y-4 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-7 mt-3 sm:mt-0 sm:py-10 lg:gap-x-11'>
            <motion.li  variants={listvariant} className='flex flex-col items-center '><img src={meter1} alt="" />
              <p className=' mt-3 font-medium text-lg'>Web Development</p></motion.li>
            <motion.li variants={listvariant} className='flex flex-col items-center '><img src={meter2} alt="" />
              <p className=' mt-3 font-medium text-lg'>Brand Identitiy</p></motion.li>
            <motion.li variants={listvariant} className='flex flex-col items-center '><img src={meter3} alt="" />
              <p className=' mt-3 font-medium text-lg'>Logo Design</p></motion.li>
          </motion.ul>
        </motion.div>
      </div>
